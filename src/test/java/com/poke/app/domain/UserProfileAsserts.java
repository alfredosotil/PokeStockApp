...
public class UserProfileAsserts {
    ...
    public static void assertUserProfileUpdatableFieldsEquals(UserProfile expected, UserProfile actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getFavoriteSet()).as("check favoriteSet").isEqualTo(expected.getFavoriteSet()))
            .satisfies(a -> assertThat(a.getPlaystyle()).as("check playstyle").isEqualTo(expected.getPlaystyle()))
            .satisfies(a -> assertThat(a.getAvatar()).as("check avatar").isEqualTo(expected.getAvatar()))
            .satisfies(a -> assertThat(a.getAvatarContentType()).as("check avatar contenty type").isEqualTo(expected.getAvatarContentType())
            );
    }
