...
class NotificationResourceIT {
    ...
    private static final NotificationType DEFAULT_TYPE = NotificationType.PRICE_ALERT;
    private static final NotificationType UPDATED_TYPE = NotificationType.TRADE_PROPOSAL;
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.type(UPDATED_TYPE).message(UPDATED_MESSAGE).read(UPDATED_READ);
