...
class UserProfileResourceIT {
    ...
    private static final String DEFAULT_FAVORITE_SET = "AAAAAAAAAA";
    private static final String UPDATED_FAVORITE_SET = "BBBBBBBBBB";

    private static final String DEFAULT_PLAYSTYLE = "AAAAAAAAAA";
    private static final String UPDATED_PLAYSTYLE = "BBBBBBBBBB";
    ...
    public static UserProfile createEntity() {
        return new UserProfile()
            ...
            .favoriteSet(DEFAULT_FAVORITE_SET)
    ...
    public static UserProfile createUpdatedEntity() {
        return new UserProfile()
            ...
            .favoriteSet(UPDATED_FAVORITE_SET)
            .playstyle(UPDATED_PLAYSTYLE)
    ...
    void getAllUserProfiles() throws Exception {
        ...
        restUserProfileMockMvc
            ...
            .andExpect(jsonPath("$.[*].favoriteSet").value(hasItem(DEFAULT_FAVORITE_SET)))
            .andExpect(jsonPath("$.[*].playstyle").value(hasItem(DEFAULT_PLAYSTYLE)))
    ...
    void getUserProfile() throws Exception {
        ...
        restUserProfileMockMvc
            ...
            .andExpect(jsonPath("$.favoriteSet").value(DEFAULT_FAVORITE_SET))
            .andExpect(jsonPath("$.playstyle").value(DEFAULT_PLAYSTYLE))
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.location(UPDATED_LOCATION).avatar(UPDATED_AVATAR).avatarContentType(UPDATED_AVATAR_CONTENT_TYPE);
