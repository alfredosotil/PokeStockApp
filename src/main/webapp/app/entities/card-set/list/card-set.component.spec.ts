...
import { sampleWithRequiredData } from '../card-set.test-samples';
import { CardSetService } from '../service/card-set.service';

import { CardSetComponent } from './card-set.component';
import SpyInstance = jest.SpyInstance;

describe('CardSet Management Component', () => {
  let comp: CardSetComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CardSetComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.cardSets()[0]).toEqual(expect.objectContaining({ id: 12456 }));
  });

  describe('trackId', () => {
    it('should forward to cardSetService', () => {
      const entity = { id: 12456 };
      jest.spyOn(service, 'getCardSetIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCardSetIdentifier).toHaveBeenCalledWith(entity);
